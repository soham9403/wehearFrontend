    ...
    return (
        <div className='we_container analytics_area'>
            <Grid container spacing={2} justifyContent={"center"} className="m-v-primary">
                {
                    userInventoryData && <Grid xs={6} md={3} container item>
                        <button className='analytic-btn df center column radius-1 bg-light row analytic-btn-active pointer'>
                ...
                }
                {
                    userInventoryData && userInventoryData.inventory && <Grid xs={6} md={3} container item>
                        <button className='analytic-btn df center column radius-1 bg-light row'>
