                                ...
                                {<>
                                    ...
                                    <Table aria-label="table" sx={{ mb: 2 }}>
                                        ...
                                        <>
                                            ...
                                            <TableRow>
                                                <TableCell>  <span className="font-bold" variant="h3">{_lang('mac_id')}</span></TableCell>
                                                <TableCell>  <span variant="h4">{_lang(row.mac_id)}</span></TableCell>
                                            </TableRow>
                                            <TableRow>
                                                <TableCell>  <span className="font-bold" variant="h3">{_lang('packing_date')}</span></TableCell>
                                                <TableCell>  <span variant="h4">{dateToDDMMYYYY(_lang(row.packing_date))}</span></TableCell>
    ...
    return (
        <div className="we_container m-v-primary">
            ...
            <div className='row'>
                ...
                <div className='m-v-primary row'>
                    <Typography sx={{ textTransform: "none" }} variant='h4'>{_lang('latest_sales')}</Typography>
                </div>
