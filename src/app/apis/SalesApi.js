    ...
    .catch(async err => {
      if (err.response.status === 401) {
        return await resetToken(async () => {
          return await getSalesListApi(params)
        })
      }
...
export const transferBoxApi = async params => {
  return await axios({
    ...
    .catch(async err => {
      if (err.response.status === 401) {
        return await resetToken(async () => {
          return await transferBoxApi(params)
        })
      }
      return err.response.data
    })
...
export const transferBoxBulkApi = async params => {
  return await axios({
    ...
    .catch(async err => {
      if (err.response.status === 401) {
        return await resetToken(async () => {
          return await transferBoxBulkApi(params)
        })
      }
      return err.response.data
    })
...
export const saleBoxApi = async params => {
  return await axios({
    ...
    .catch(async err => {
      if (err.response.status === 401) {
        return await resetToken(async () => {
          return await saleBoxApi(params)
        })
      }
      return err.response.data
    })
...
export const getRangedDataApi = async params => {
  return await axios({
    ...
    .catch(async err => {
      if (err.response.status === 401) {
        return await resetToken(async () => {
          return await getRangedDataApi(params)
        })
      }
      return err.response.data
    })
...
export const exportSalesApi = async params => {
  ...
  return await axios({
    ...
    .catch(async err => {
      if (err.response.status === 401) {
        return await resetToken(async () => {
          return await exportSalesApi(params)
        })
      }
      return err.response.data
    })
...
export const uploadCsvData = async data => {
  return await axios({
    url: apiurl.uploadcsvData,
    method: 'POST',
    ...
    .catch(async err => {
      if (err.response.status === 401) {
        return await resetToken(async () => {
          return await uploadCsvData(data)
        })
      }
      return err.response.data
    })
